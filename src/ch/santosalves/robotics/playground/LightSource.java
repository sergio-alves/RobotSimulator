...
import ch.santosalves.robotics.playground.api.LightType;
 ...
 * @author Sergio
 */
public class LightSource extends JComponent implements ch.santosalves.robotics.playground.api.LightSource{
...
//                    if()
    ...
    protected double getSphereSurface(double radius) {
        return 4 * Math.PI*Math.pow(radius,2);           
    }
    
    protected double getCircleSurface(double radius) {
